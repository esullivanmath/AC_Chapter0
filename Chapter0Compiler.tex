...
\title{Active Calculus \& Mathematical Modeling \\ Carroll College \\ \vspace{0.1in} \scalebox{0.75}{\includegraphics{figures/CClicense.eps}}}
...
\include{0.chap} % Pre Calc topics
