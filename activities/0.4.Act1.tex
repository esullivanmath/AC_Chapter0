	...
	\begin{center}         
		\begin{tikzpicture}[scale=1]             
			\begin{axis}[axis lines=center, xlabel={$x$}, ylabel={$y$}, domain=0:4,
				...
				\addplot[smooth, thick, blue, samples=150, domain=1:4] {ln(x)}
						[below right] node[pos=0.9] {\color{blue} D};
				\addplot[smooth, thick, red, samples=150, domain=0:1.5] {exp(x)}
						[above left] node[pos=0.02] {\color{red} A};
				\addplot[smooth, thick, green, samples=150, domain=0:4] {x^(1/2)}
						[above left] node[pos=0.9] {\color{green} C};
				\addplot[smooth, thick, purple, samples=150, domain=0:2] {x^(2)}
...
% \begin{figure}[ht!]     
	\begin{center}
			...
			\begin{axis}[axis lines=center, xlabel={$x$}, ylabel={$y$}, domain=0:4,
				...
				\addplot[smooth, thick, black, samples=150, domain=0.10:4] {ln(x)/ln(2)}
						node[pos=0.7, pin={[pin distance=1cm, pin edge={<-}]135:A}, inner sep=0pt]{};
				\addplot[smooth, thick, black, samples=150, domain=0.10:4] {ln(x)/ln(3)}
						node[pos=0.75, pin={[pin distance=1cm, pin edge={<-}]95:B}, inner sep=0pt]{};
				\addplot[smooth, thick, black, samples=150, domain=0.10:4] {ln(x)/ln(5)}
						node[pos=0.78, pin={[pin distance=15mm, pin edge={<-}]271:C}, inner sep=0pt]{};
				\addplot[smooth, thick, black, samples=150, domain=0.10:4] {ln(x)/ln(10)}
