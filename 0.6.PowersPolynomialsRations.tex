...
\input{activities/0.6.Act3}  % Vertical Asymptotes and 0/0

\input{activities/0.6.Act4}  % Horizontal Asymptotes and infinity/infinity.

\input{activities/0.6.Act5}  % Crossing Horizontal Asymptotes
...
% exercises go here
\input{exercises/0.6.PowersPolynomialsRationals(Ex)}
